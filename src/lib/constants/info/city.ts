...
export const cities: City[] = [
  ...
  },
  {
    ...
    region: "AK",
    country: "United States",
    subtitle: "Emerald Isle City",
    quote:
      "In the city where the mountains meet the sea and the forests embrace the sky, we found a paradise of stunning beauty and vibrant culture, our spirits lifted by the warmth and hospitality of the Sitka people.",
  },
  {
    city: "Skagway",
    state: "AK",
    ...
    quote:
      "In the land where the gold rush dreams were born, we walked the historic streets and sailed the pristine waters, our hearts and minds forever changed by the beauty and history that define Skagway.",
  },
  {
    city: "Svaneti Region",
    state: "",
    ...
    country: "Georgia",
    subtitle: "Land of Glaciers and Towers",
    quote:
      "In the Caucasus where ancient traditions thrive, we trekked through a landscape of stunning beauty and rich culture, our spirits lifted by the warmth and hospitality of the Svaneti people.",
  },
  {
    city: "Sapa",
    state: "",
    ...
    country: "Vietnam",
    subtitle: "Terraced Rice Fields",
    quote:
      "In the mountains where the clouds kiss the earth and the rice terraces stretch like emerald ribbons, we found a paradise of stunning beauty and vibrant culture, our spirits lifted by the warmth and hospitality of the Sapa people.",
  },
  {
    city: "Sydney",
    state: "NSW",
  ...
  },
  {
    ...
    region: "DC",
    country: "United States",
    subtitle: "Capital of the United States",
    quote:
      "In the city where history and power converge, we explored a vibrant tapestry of culture and politics that left an indelible mark on our hearts and minds.",
  },
  {
    city: "Xi'an",
    state: "",
