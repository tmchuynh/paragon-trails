...
export const cities: City[] = [
  ...
  },
  {
    ...
    region: "Quintana Roo",
    country: "Mexico",
    subtitle: "Island Paradise in the Caribbean",
    quote:
      "In the turquoise embrace of the Caribbean, we found a sanctuary of sun and sea, our spirits lifted by the vibrant culture and stunning landscapes that define Cozumel.",
  },
  {
    city: "Đà Nẵng",
    state: "",
  ...
  },
  {
    ...
    country: "Ireland",
    isPopular: true,
    subtitle: "Capital of Ireland",
    quote:
      "In the city where every street is a story and every story sings a song, we wandered through a living museum of art, architecture, and culture that captivated our hearts and imaginations.",
  },
  {
    city: "Dubrovnik",
    state: "",
    ...
    quote:
      "In the city where the sea meets the sky, we walked through ancient walls and vibrant streets, our senses alive with the beauty and history that define Dubrovnik.",
  },
  {
    city: "Edinburgh",
    state: "",
  ...
  },
  {
    ...
    quote:
      "In the city where the sun shines bright and the canals flow like dreams, we found a paradise of beaches and boats, our spirits lifted by the beauty and warmth of Fort Lauderdale.",
  },
  {
    city: "Galveston",
    state: "TX",
    region: "TX",
    country: "United States",
    subtitle: "Island City on the Gulf Coast",
    quote:
      "In the land where the sea meets the shore, we discovered a vibrant tapestry of culture and history, our senses delighted by the sights, sounds, and flavors of Galveston.",
  },
  {
    city: "George Town",
    state: "",
    ...
    country: "Malaysia",
    isPopular: true,
    subtitle: "Cultural Capital of Malaysia",
    quote:
      "In the city where cultures converge, we wandered through streets alive with history and flavor, our hearts and minds forever changed by the wonders of George Town.",
  },
  {
  ...
  },
  {
    ...
    region: "AK",
    country: "United States",
    subtitle: "Alaska's Natural Wonder",
    quote:
      "In the land where glaciers carve their stories into the earth, we stood in awe of nature's grandeur, our hearts and minds forever changed by the beauty and majesty of Glacier Bay.",
  },
  {
    city: "Helsinki",
    state: "",
  ...
  },
  {
    ...
    subtitle: "Pearl of the Orient",
    quote:
      "In the city where east meets west, we wandered through a vibrant tapestry of cultures and cuisines, our senses delighted by the flavors and sounds of a land that is as diverse as it is enchanting.",
  },
  {
    city: "Istanbul",
    state: "",
  ...
  },
  {
    ...
    region: "AK",
    country: "United States",
    subtitle: "Salmon Capital of the World",
    quote:
      "In the land where the rivers run wild and the mountains touch the sky, we found a paradise of stunning beauty and vibrant culture, our spirits lifted by the warmth and hospitality of Ketchikan.",
  },
  {
    city: "Kiel",
    state: "",
    ...
    country: "Germany",
    subtitle: "Gateway to the Baltic Sea",
    quote:
      "In the city where the sea meets the shore, we discovered a vibrant tapestry of culture and history, our senses delighted by the sights, sounds, and flavors of Kiel.",
  },
  {
    city: "Kyoto",
    state: "",
  ...
  },
  {
    ...
    subtitle: "Magic City",
    quote:
      "In the city where the sun shines bright and the beaches beckon, we found a paradise of stunning beauty and vibrant culture, our spirits lifted by the warmth and hospitality of Miami.",
  },
  {
    city: "Milan",
    state: "",
    ...
    country: "Italy",
    isPopular: true,
    subtitle: "Fashion Capital of the World",
    quote:
      "In the city where style meets substance, we wandered through a living museum of art, architecture, and culture that captivated our hearts and minds.",
  },
  {
    city: "Monaco",
    state: "",
  ...
  },
  {
    ...
    region: "Monaco",
    country: "Monaco",
    subtitle: "Glamour of the French Riviera",
    quote:
      "In the city where the sea sparkles like diamonds and the streets hum with luxury, we tasted the good life, our senses delighted by the beauty and opulence that define Monte Carlo.",
  },
  {
    city: "Montevideo",
    state: "",
    ...
    country: "Uruguay",
    subtitle: "Capital of Uruguay",
    quote:
      "In the city where the river meets the sea, we discovered a vibrant tapestry of culture and history, our senses delighted by the sights, sounds, and flavors of Montevideo.",
  },
  {
    city: "Mostar",
    state: "",
  ...
  },
  {
    ...
    country: "Greece",
    isPopular: true,
    subtitle: "Island of the Winds",
    quote:
      "In the Aegean where the sun kisses the sea, we sailed between islands of myth and marble, our hearts and minds enchanted by the beauty and history that define Mykonos.",
  },
  {
    city: "Naples",
    country: "Italy",
  ...
  },
  {
    ...
    country: "Kenya",
    isPopular: true,
    subtitle: "Capital of Kenya",
    quote:
      "In the city where the wild meets the urban, we discovered a vibrant tapestry of culture and nature, our senses delighted by the sights, sounds, and flavors of Nairobi.",
  },
  {
    city: "Nagasaki",
    state: "",
    region: "Kyushu",
    country: "Japan",
    subtitle: "City of Peace",
    quote:
      "In the city where history and hope intertwine, we wandered through a living museum of art, architecture, and culture that captivated our hearts and minds.",
  },
  {
    city: "Nassau",
    state: "",
    ...
    country: "Bahamas",
    subtitle: "Capital of the Bahamas",
    quote:
      "In the heart of the Caribbean, we found a paradise of sun and sea, our spirits lifted by the vibrant culture and stunning landscapes that define Nassau.",
  },
  {
    city: "New Orleans",
    state: "LA",
  ...
  },
  {
    ...
    country: "Panama",
    isPopular: true,
    subtitle: "Gateway to the Americas",
    quote:
      "In the city where the Pacific meets the Atlantic, we discovered a vibrant tapestry of culture and history, our senses delighted by the sights, sounds, and flavors of Panama City.",
  },
  {
    city: "Panauti",
    state: "",
  ...
  },
  {
    ...
    subtitle: "Capital of Sint Maarten",
    quote:
      "In the heart of the Caribbean, we found a paradise of sun and sea, our spirits lifted by the vibrant culture and stunning landscapes that define Philipsburg.",
  },
  {
    city: "Patagonia",
    state: "",
  ...
  },
  {
    ...
    country: "Vanuatu",
    subtitle: "Capital of Vanuatu",
    quote:
      "In the embrace of the Pacific, we found a paradise of sun and sea, our spirits lifted by the vibrant culture and stunning landscapes that define Port Vila.",
  },
  {
    city: "Phnom Penh",
    state: "",
  ...
  },
  {
    ...
    country: "Mexico",
    isPopular: true,
    subtitle: "Jewel of the Pacific",
    quote:
      "In the city where the mountains meet the sea, we found a paradise of stunning beaches and vibrant culture, our spirits lifted by the warmth and hospitality of the Puerto Vallarta people.",
  },
  {
    city: "Punta Cana",
    state: "",
    region: "La Altagracia Province",
    country: "Dominican Republic",
    isPopular: true,
    subtitle: "Caribbean Paradise",
    quote:
      "In the land where the sun kisses the sea and the palm trees sway in the breeze, we found a paradise of stunning beaches and vibrant culture, our spirits lifted by the warmth and hospitality of Punta Cana.",
  },
  {
    city: "Qaqortoq",
    state: "",
    region: "Sermersooq",
    country: "Greenland",
    subtitle: "Greenland's Southern Gem",
    quote:
      "In the land where the ice meets the sea, we found a vibrant tapestry of culture and nature, our senses delighted by the sights, sounds, and flavors of Qaqortoq.",
  },
  {
    city: "Quebec City",
    state: "QC",
    ...
    country: "Canada",
    isPopular: true,
    subtitle: "Capital of French Canada",
    quote:
  ...
  },
  {
    ...
    subtitle: "Caribbean Paradise",
    quote:
      "In the heart of the Caribbean, we found a paradise of sun and sea, our spirits lifted by the vibrant culture and stunning landscapes that define Roatan.",
  },
  {
    city: "Rome",
    state: "",
  ...
  },
  {
    ...
    quote:
      "In the city where innovation meets tradition, we explored a vibrant tapestry of culture and creativity that left an indelible mark on our hearts and minds.",
  },
  {
    city: "Sacramento",
    state: "CA",
    region: "CA",
    country: "United States",
    subtitle: "California's Capital City",
    quote:
      "In the city where the past and present converge, we savored the flavors and sounds of a culture that is as rich and vibrant as it is welcoming.",
  },
  {
  ...
  },
  {
    ...
    country: "Puerto Rico",
    isPopular: true,
    subtitle: "Capital of Puerto Rico",
    quote:
      "In the heart of the Caribbean, we found a paradise of sun and sea, our spirits lifted by the vibrant culture and stunning landscapes that define San Juan.",
  },
  {
    city: "Santiago",
    state: "",
    ...
    country: "Chile",
    isPopular: true,
    subtitle: "Capital of Chile",
    quote:
      "In the city where the Andes touch the sky and the culture thrives, we discovered a vibrant tapestry of history and innovation that captivated our hearts and minds.",
  },
  {
    city: "Seattle",
    state: "WA",
  ...
  },
  {
    ...
    country: "Sweden",
    isPopular: true,
    subtitle: "Capital of Sweden",
    quote:
      "In the city where the archipelago meets the sky, we discovered a harmonious blend of nature and nurture, our senses delighted by the beauty and innovation that define Stockholm.",
  },
  {
    city: "Southampton",
    state: "",
    ...
    country: "United Kingdom",
    subtitle: "Gateway to the New World",
    quote:
      "In the port where the ocean meets the land, we discovered a vibrant tapestry of culture and history, our senses delighted by the sights, sounds, and flavors of Southampton.",
  },
  {
    city: "St. Petersburg",
    state: "",
    ...
    country: "Russia",
    isPopular: true,
    subtitle: "Cultural Capital of Russia",
    quote:
      "In the city where the rivers flow like veins and the palaces rise like dreams, we wandered through a living museum of art, architecture, and culture that captivated our hearts and minds.",
  },
  {
    city: "St. Thomas",
    state: "",
    ...
    subtitle: "Gateway to the Caribbean",
    quote:
      "In the heart of the Caribbean, we found a paradise of sun and sea, our spirits lifted by the vibrant culture and stunning landscapes that define St. Thomas.",
  },
  ...
  },
  {
    ...
    country: "Taiwan",
    isPopular: true,
    subtitle: "Capital of Taiwan",
    quote:
      "In the city where tradition and modernity coexist in harmony, we discovered a vibrant tapestry of culture and innovation that captivated our hearts and minds.",
  },
  {
    city: "Tbilisi",
    state: "",
  ...
  },
  {
    ...
    country: "Morocco",
    subtitle: "Gateway to Africa",
    quote:
      "In the city where the Mediterranean meets the Atlantic, we discovered a vibrant tapestry of culture and history, our senses delighted by the sights, sounds, and flavors of Tangier.",
  },
  {
    city: "Toronto",
    state: "ON",
    ...
    country: "Canada",
    isPopular: true,
    subtitle: "Cultural Mosaic of Canada",
    quote:
      "In the city where every neighborhood tells a story and every story sings a song, we wandered through a living museum of art, architecture, and culture that captivated our hearts and imaginations.",
  },
  {
    city: "Udaipur",
    state: "Rajasthan",
  ...
  },
  {
    ...
    subtitle: "Garden City",
    quote:
      "In the city where the gardens bloom and the ocean sparkles, we found a paradise of stunning beauty and vibrant culture, our spirits lifted by the warmth and hospitality of the Victoria people.",
  },
  {
    city: "Yokohama",
    country: "Japan",
