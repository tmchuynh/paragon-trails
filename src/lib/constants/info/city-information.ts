export const amalfiCoast = {
  ...
  city: "Amalfi Coast",
  country: "Italy",
  quote: "A breathtaking stretch of Italian coastline.",
  subtitle: "Italy's dramatic coastal paradise",
  isPopular: true,
  coordinates: { lat: 40.6333, lng: 14.6029 },
  imageUrl: "",
  rating: 4.8,
  description: "Placeholder for Amalfi Coast. Please update with real data.",
  population: 0,
...
export const amsterdam = {
  ...
  city: "Amsterdam",
  country: "Netherlands",
  quote: "Venice of the North.",
  subtitle: "Dutch canals and culture",
  isPopular: true,
  coordinates: { lat: 52.3676, lng: 4.9041 },
  imageUrl: "",
  rating: 4.7,
  description: "Placeholder for Amsterdam. Please update with real data.",
  population: 0,
...
export const berlin = {
  ...
  city: "Berlin",
  country: "Germany",
  quote: "A city of history, culture, and innovation.",
  subtitle: "Germany's vibrant capital",
  isPopular: true,
  coordinates: { lat: 52.52, lng: 13.405 },
  imageUrl: "https://images.unsplash.com/photo-1506744038136-46273834b3fb",
  rating: 4.7,
  description:
    "Berlin is known for its rich history, creative scene, and dynamic neighborhoods. Explore the Berlin Wall, museums, and world-class nightlife.",
  population: 3769000,
  ...
  tags: ["historic", "cultural", "nightlife", "art", "modern"],
  climate: "Oceanic",
  localDialingCode: "+49",
  topAttractions: [
    "brandenburg-gate",
...
export const buenosAires = {
  ...
  city: "Buenos Aires",
  country: "Argentina",
  quote: "The Paris of South America, where tango and passion meet.",
  subtitle: "Argentina's cosmopolitan capital",
  isPopular: true,
  coordinates: { lat: -34.6037, lng: -58.3816 },
  imageUrl: "https://images.unsplash.com/photo-1506744038136-46273834b3fb",
  rating: 4.7,
  description:
    "Buenos Aires is famous for its European-style architecture, vibrant nightlife, and tango music. Explore historic neighborhoods, steakhouses, and cultural landmarks.",
  population: 2890000,
  ...
  tags: ["cultural", "historic", "nightlife", "tango", "culinary"],
...
export const auckland = {
  ...
  city: "Auckland",
  country: "New Zealand",
  quote: "City of Sails and volcanic beauty.",
  subtitle: "New Zealand's largest city",
  isPopular: true,
  coordinates: { lat: -36.8485, lng: 174.7633 },
  imageUrl: "",
  rating: 4.7,
  description: "Placeholder for Auckland. Please update with real data.",
  population: 0,
  timeZone: "Pacific/Auckland",
  isEcoCertified: false,
  currency: "NZD",
  priceCategory: "moderate",
  languagesSpoken: ["English", "Maori"],
  tags: ["urban", "harbor", "nature"],
  climate: "Oceanic",
  localDialingCode: "+64",
  topAttractions: [],
  services: {},
...
export const cartagena = {
  ...
  city: "Cartagena",
  country: "Colombia",
  quote: "A walled city of romance and Caribbean flair.",
  subtitle: "Colombia's jewel on the Caribbean coast",
  isPopular: true,
  coordinates: { lat: 10.391, lng: -75.4794 },
  imageUrl: "https://images.unsplash.com/photo-1506744038136-46273834b3fb",
  rating: 4.7,
  description:
    "Cartagena is known for its colonial architecture, vibrant culture, and Caribbean beaches. Explore the old city, fortresses, and lively plazas.",
  population: 914552,
  ...
  priceCategory: "moderate",
  languagesSpoken: ["Spanish", "English"],
  tags: ["historic", "beach", "colonial", "romantic", "cultural"],
  climate: "Tropical",
  localDialingCode: "+57",
  topAttractions: [
    "walled-city",
...
export const florence = {
  ...
  city: "Florence",
  country: "Italy",
  quote: "The cradle of the Renaissance.",
  subtitle: "Italy's city of art and history",
  isPopular: true,
  coordinates: { lat: 43.7696, lng: 11.2558 },
  imageUrl: "https://images.unsplash.com/photo-1506744038136-46273834b3fb",
  rating: 4.8,
  description:
    "Florence is renowned for its art, architecture, and history. Visit the Uffizi Gallery, Duomo, and stroll the Arno River.",
  population: 382258,
  timeZone: "Europe/Rome",
  isEcoCertified: false,
  currency: "EUR",
  priceCategory: "luxury",
  languagesSpoken: ["Italian", "English"],
  tags: ["art", "historic", "architecture", "museum", "romantic"],
  climate: "Mediterranean",
  localDialingCode: "+39",
  topAttractions: [
    "uffizi-gallery",
...
export const galveston = {
  ...
  state: "Texas",
  country: "United States",
  quote: "Historic port city with Gulf Coast charm.",
  subtitle: "Texas' island getaway",
  isPopular: false,
  coordinates: { lat: 29.3013, lng: -94.7977 },
  imageUrl: "",
  rating: 4.4,
  description: "Placeholder for Galveston. Please update with real data.",
  population: 0,
...
export const georgeTown = {
  ...
  quote: "Caribbean capital of finance and beaches.",
  subtitle: "Cayman Islands' vibrant hub",
  isPopular: false,
  coordinates: { lat: 19.2866, lng: -81.3744 },
  imageUrl: "",
  rating: 4.5,
  description: "Placeholder for George Town. Please update with real data.",
  population: 0,
  ...
  priceCategory: "moderate",
  languagesSpoken: ["English"],
  tags: ["beach", "finance", "cruise-port"],
  climate: "Tropical",
