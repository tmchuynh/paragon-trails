...
export const stockholmTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the Nybrokajen marina, pier #5. Look for the white sailboat named 'Stockholm Vind'.",
    ...
    cancellationPolicy: "Full refund if canceled 72 hours in advance. 50% refund if canceled 48-72 hours in advance. No refund for cancellations less than 48 hours before scheduled departure.",
    isHistorical: false,
    isRomantic: true,
    ...
    faqs: [
      {
        ...
        answer: "No sailing experience is required. Our professional crew handles the yacht, but interested guests are welcome to learn basic sailing techniques and help with simple tasks if desired."
      },
      {
        question: "What should I bring on the tour?",
        answer: "Wear comfortable clothing and soft-soled shoes. Bring swimwear, a towel, sunscreen, sunglasses, a hat, and a light windproof jacket. Don't forget your camera!"
      },
      {
        question: "What if the weather is bad?",
        answer: "For safety reasons, tours may be rescheduled or canceled in case of high winds or severe weather. We'll offer an alternative date or a full refund if the tour cannot proceed due to weather conditions."
      }
    ],
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at Stortorget square in Gamla Stan, by the Nobel Museum entrance. Your guide will be holding a blue umbrella with 'Stockholm History Tours' printed on it.",
    ...
    cancellationPolicy: "Full refund if canceled 24 hours in advance. No refund for cancellations less than 24 hours before the tour or no-shows.",
    isHistorical: true,
    isRomantic: false,
    ...
    faqs: [
      {
        ...
        answer: "The Royal Palace is the official residence of His Majesty the King of Sweden, but the royal family primarily lives at Drottningholm Palace. While royal sightings are rare, the flag indicates when the King is in residence."
      },
      {
        question: "When does the Changing of the Guards ceremony take place?",
        answer: "The Royal Guards ceremony takes place daily at 12:15 PM during summer months (May-August) and at 12:15 PM on weekdays and 1:15 PM on Sundays and holidays during the rest of the year. The ceremony lasts about 40 minutes."
      },
      {
        question: "How much walking is involved?",
        answer: "This tour involves approximately 2-3 km (1.2-1.8 miles) of walking on cobblestone streets in the Old Town. Comfortable walking shoes are strongly recommended."
      }
    ],
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the main entrance of Östermalmshallen food market. Your guide will be holding a sign with 'Stockholm Food Tour' written on it.",
    ...
    faqs: [
      {
        ...
        answer: "The menu changes seasonally but typically includes traditional Swedish dishes with modern interpretations. Examples include cured salmon with dill sauce, Swedish meatballs with lingonberry, or venison with forest mushrooms. Vegetarian options are available upon request."
      },
      {
        question: "Do I need cooking experience?",
        answer: "No prior cooking experience is necessary. Our professional chef will guide you through all techniques and preparations in a fun, approachable way suitable for all skill levels."
      },
      {
        question: "Can dietary restrictions be accommodated?",
        answer: "Yes, we can accommodate most dietary restrictions including vegetarian, gluten-free, and dairy-free with advance notice. Please inform us of any allergies or dietary needs when booking."
      }
    ],
  }
];
