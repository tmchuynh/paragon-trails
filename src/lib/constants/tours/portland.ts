...
export const portlandTours: Tour[] = [
  {
    ...
    meetingPoint: "First brewery location",
  ...
  },
  {
    ...
    meetingPoint: "First food cart location",
    cancellationPolicy: "Free cancellation up to 24 hours before the tour.",
    isHistorical: false,
    isRomantic: false,
    isAdventure: false,
  ...
  },
  {
    ...
    meetingPoint: "Downtown Portland, near Pioneer Courthouse Square",
    cancellationPolicy: "Free cancellation up to 24 hours before the tour.",
    isHistorical: true,
    isRomantic: false,
    isAdventure: false,
  ...
  },
  {
    ...
    meetingPoint: "Forest Park entrance, near NW Thurman St.",
    cancellationPolicy: "Free cancellation up to 24 hours before the tour.",
    isHistorical: false,
    isRomantic: false,
    isAdventure: true,
  ...
  },
  {
    ...
    meetingPoint: "Pearl District, near NW 13th Ave.",
    cancellationPolicy: "Free cancellation up to 24 hours before the tour.",
    isHistorical: true,
    isRomantic: false,
    isAdventure: false,
  ...
  },
  {
    ...
    meetingPoint: "First bar location in downtown Portland",
    cancellationPolicy: "Free cancellation up to 24 hours before the tour.",
    isHistorical: false,
    isRomantic: false,
    isAdventure: false,
  ...
  },
  {
    ...
    meetingPoint: "Wellness center, downtown Portland",
