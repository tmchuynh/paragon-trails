...
export const montrealTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet your guide in front of the Notre-Dame Basilica main entrance. Guide will be holding a red and white sign with 'Montreal Heritage Tours'.",
  ...
  
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet in front of the iconic Schwartz's Deli on Saint-Laurent Boulevard. Your guide will be holding a sign reading 'Montreal Food Tour'.",
    ...
    faqs: [
      {
        ...
        answer: "The tour includes six substantial food tastings that amount to a full meal. Come hungry! You'll sample Montreal's iconic dishes including smoked meat, bagels, Portuguese pastries, Quebec cheeses, market fresh specialties, and a sweet treat, plus a craft beer or non-alcoholic beverage."
      },
      {
        question: "Can dietary restrictions be accommodated?",
        answer: "Yes, we can accommodate most dietary restrictions including vegetarian, gluten-free, and most allergies with advance notice. Please inform us of any dietary needs when booking so we can make appropriate arrangements. Due to the specialized nature of the tastings, vegan options may be limited at some stops."
      },
      {
        question: "What makes Montreal's food scene unique?",
        answer: "Montreal's culinary landscape has been shaped by waves of immigration and the blending of French and English influences. The city is famous for its unique specialties like Montreal-style bagels (smaller, sweeter and wood-fired), smoked meat (a distinctive cured beef), and poutine (fries with cheese curds and gravy). Our tour highlights how each immigrant community contributed to the rich tapestry of flavors that define Montreal cuisine today."
      },
    ],
  },
  
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet in the main lobby of Place Ville Marie, near the central sculpture. Your guide will be holding a blue folder with 'Underground City Tour' written on it.",
      contactNumber: "+1 514-555-3456",
      contactEmail: "undergroundcity@paragontrails.com",
    },
    
    availableDates: [
      "2023-12-17", "2023-12-18", "2023-12-24", "2023-12-25", "2023-12-31", 
      "2024-01-07", "2024-01-08", "2024-01-14", "2024-01-15", "2024-01-21", "2024-01-22", "2024-01-28", "2024-01-29",
      "2024-02-04", "2024-02-05", "2024-02-11", "2024-02-12", "2024-02-18", "2024-02-19", "2024-02-25", "2024-02-26",
    ],
  ...
  
  {
    ...
    meetingPoint: {
      address: "Mont-Royal Metro Station, 470 Avenue du Mont-Royal Est, Montreal",
      coordinates: {
        latitude: 45.5244,
        longitude: -73.5819,
      },
      instructions: "Meet outside the main entrance to Mont-Royal Metro Station. Your guide will be wearing a colorful jacket and holding a 'Mural Art Tour' sign.",
