...
export const austinTours: Tour[] = [
  {
    ...
    itinerary: [
      "7:00 PM: Meet your guide at the designated starting point",
      "7:15 PM: Brief introduction to Austin's music scene",
      "7:30 PM: First venue with welcome drink and initial performance",
      "8:30 PM: Second venue with different musical genre",
      "9:30 PM: Backstage access and meet-and-greet with performers",
  ...
  },
  {
    ...
    itinerary: [
      ...
      "1:45 PM: Second BBQ location featuring unique regional style",
      "3:00 PM: Second brewery visit with behind-the-scenes access",
      "4:15 PM: Final BBQ stop for specialty items and sides",
  ...
  },
  {
    ...
    itinerary: [
      "9:00 AM: Meet your guide at the designated starting point",
      "9:15 AM: Shuttle to the kayak launch site",
      "9:30 AM: Kayak safety briefing and equipment check",
  ...
  },
  {
    ...
    itinerary: [
      ...
      "1:00 PM: Lunch break at a local restaurant or winery (not included)",
      "2:00 PM: Depart for third winery",
      "2:30 PM: Arrive at third winery for tasting and tour",
      "3:30 PM: Depart for final winery",
      "4:00 PM: Arrive at final winery for tasting and tour",
      "5:00 PM: Depart for Austin",
