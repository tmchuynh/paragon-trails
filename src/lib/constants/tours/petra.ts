...
export const petraTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the main entrance gate of Petra Visitor Center. Your guide will be holding a lantern with a Paragon Trails sign.",
    ...
    faqs: [
      {
        ...
        answer:
          "Yes, photography is permitted, but flash photography is prohibited as it disturbs the ambiance and other visitors. For the best results, we recommend cameras with good low-light capabilities. Tripods require special permission and additional fees from the Petra authorities.",
      },
      {
        question: "How difficult is the walking during this tour?",
        answer:
          "The walk through the Siq to the Treasury is approximately 2 km (1.2 miles) round-trip on mostly flat terrain. The path is illuminated by candles, but some sections can be uneven. Comfortable, closed-toe walking shoes are strongly recommended. The pace is leisurely, making it suitable for most fitness levels.",
      },
      {
        question: "Do I need a regular Petra ticket to attend Petra by Night?",
        answer:
          "No, Petra by Night requires a separate ticket (included in this tour). However, if you wish to visit Petra during the day, you'll need to purchase a regular entrance ticket. We recommend visiting during daytime hours first to fully appreciate the nighttime experience.",
      },
    ],
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet in the main lobby of the Movenpick Resort Petra. Your archaeologist guide will be holding a sign with 'Archaeological Petra Tour' written on it.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the entrance of Petra Guest House Hotel. Your Bedouin guide will be wearing a traditional red-and-white shemagh headscarf and holding a hiking stick.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet in the lobby of Petra Moon Hotel with your overnight bag. Look for your guide holding a 'Petra-Wadi Rum Journey' sign.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet outside the main entrance of the Petra Visitor Center. Your Bedouin host will greet you wearing a traditional outfit and introduce himself as 'Abu Ibrahim'.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the entrance to Basin Restaurant in the center of Petra. This is past the Treasury, approximately 30 minutes walk from the main entrance. Look for guide with a blue flag.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the main entrance gate of Petra Visitor Center. Your photography guide will be carrying a professional camera with a tripod and wearing a navy blue photography vest.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet in the lobby of Petra Moon Hotel. Your guide will be holding a sign with 'Little Petra Tour' written on it.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet in the Movenpick Resort Petra lobby. Your guide will be holding a lantern with a 'Moonlight Tour' sign.",
      contactNumber: "+962 3 215 7101",
      contactEmail: "moonlight@paragontrails.com",
    },

    availableDates: ["2023-12-27", "2024-01-25", "2024-02-24"],
