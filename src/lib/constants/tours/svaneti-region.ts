...
export const svanetiRegionTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the central square in Mestia near the Tourism Information Center. Your guide will be waiting with a 'Svaneti Tours' sign.",
    ...
    cancellationPolicy:
      "Full refund if canceled 7 days in advance. 50% refund if canceled 3-7 days before departure. No refund for cancellations less than 3 days in advance. Alternative dates offered in case of severe weather affecting access.",
    isHistorical: true,
    isRomantic: false,
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the Svaneti Trekking Center office in Mestia. Look for the building with mountain gear displayed in the windows.",
    ...
    cancellationPolicy:
      "Full refund if canceled 14 days in advance. 50% refund if canceled 7-14 days before departure. No refund for cancellations less than 7 days before trek. Alternative dates offered in case of severe weather.",
    isHistorical: false,
    isRomantic: false,
    isOffTheBeatenPath: true,
    isLocalExperience: true,
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet in the lobby of Hotel Suntower in Mestia. Your photography guide will welcome you with a photography briefing.",
    ...
    cancellationPolicy:
      "Full refund if canceled 21 days in advance. 50% refund if canceled 10-21 days before departure. No refund for cancellations less than 10 days before tour. Weather-dependent alternative shooting locations are provided rather than cancellation.",
    isHistorical: true,
    isRomantic: false,
    isOffTheBeatenPath: true,
    isLocalExperience: true,
