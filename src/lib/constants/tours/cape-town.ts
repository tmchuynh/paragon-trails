...
export const capeTownTours: Tour[] = [
  {
    ...
    meetingPoint: {
      address: "Kloof Nek Road, Table Mountain Lower Cable Station, Cape Town, South Africa",
      coordinates: {
        latitude: -33.9646,
        longitude: 18.4055
      },
      instructions: "Meet your guide at the parking lot entrance of the Table Mountain Lower Cable Station. Your guide will be wearing a bright orange backpack and holding a sign with 'Sunrise Hike'. Please arrive 15 minutes before the scheduled start time and bring a headlamp or flashlight as we begin hiking in the dark.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet your guide outside the Two Oceans Aquarium entrance at the V&A Waterfront. Your guide will be holding a sign with 'Cape Peninsula Tour'. Please arrive 10 minutes before the scheduled departure time.",
  ...
  },
  {
    ...
    meetingPoint: {
      address: "81 Long Street, Cape Town City Centre, Cape Town, 8001, South Africa",
      coordinates: {
        latitude: -33.9246,
        longitude: 18.4202
      },
      instructions: "Meet your wine expert guide at the Cape Heritage Hotel lobby on Long Street. Your guide will be waiting in the lobby with a wine tour folder. Please arrive 10 minutes before the departure time. Hotel pickup can be arranged for central Cape Town hotels.",
    ...
    faqs: [
      ...
      {
        question: "What makes Cape wines unique compared to other wine regions?",
        answer:
  ...
  },
  {
    ...
    meetingPoint: {
      address: "Greenmarket Square, Burg St & Longmarket St, Cape Town City Centre",
      coordinates: {
        latitude: -33.9242,
        longitude: 18.4222
      },
      instructions: "Meet your cultural guide at the center of Greenmarket Square near the craft market. Your guide will be holding a blue folder with 'Cape Town Culture Tour' written on it. Please arrive 10 minutes before the scheduled start time.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet your guide at the entrance to the Sea Point Swimming Pool on Beach Road. Your guide will be wearing a blue cap with a Paragon Trails logo. Please arrive 10 minutes before the scheduled start time.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the Quay 5 jetty in the V&A Waterfront, near the Cape Wheel. Look for the 'Sunset Cruise' sign and our boat with the Paragon Trails flag. Please arrive 20 minutes before departure for boarding procedures.",
