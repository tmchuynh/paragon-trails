...
export const chicagoTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the southeast corner of the Michigan Avenue Bridge (DuSable Bridge) by the Wrigley Building. Look for the Chicago Architecture Center tour guide in a blue shirt. Please arrive 15 minutes before departure time.",
    ...
    availableDates: [
      ...
      "2024-07-01", "2024-07-05", "2024-07-10", "2024-07-15", "2024-07-20", "2024-07-25"
    ],
    highlights: [
    ...
    cancellationPolicy: "Full refund if canceled 24 hours before the scheduled tour. 50% refund if canceled between 12-24 hours in advance. No refund for cancellations less than 12 hours before departure or no-shows.",
    faqs: [
      {
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet outside Lou Malnati's Pizzeria on North Wabash. Your guide will be wearing a blue cap with a Chicago flag logo. Please arrive 15 minutes early as we'll be entering the restaurant together.",
    ...
    cancellationPolicy: "Full refund if canceled 48 hours before the scheduled tour. 50% refund if canceled between 24-48 hours in advance. No refund for cancellations less than 24 hours before the tour or no-shows.",
    faqs: [
      {
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the Michigan Avenue entrance steps of the Art Institute of Chicago, by the iconic lion statues. Your guide will be holding a sign with 'Chicago Art Walk' written on it. Please arrive 10 minutes before tour start time.",
    ...
    cancellationPolicy: "Full refund if canceled 24 hours before the scheduled tour. 50% refund if canceled between 12-24 hours in advance. No refund for cancellations less than 12 hours before the tour or no-shows.",
    faqs: [
      {
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet in front of the Eastland Disaster memorial plaque on the north side of the Chicago River along the Riverwalk. Your guide will be dressed in 1920s-inspired attire. Please arrive 10 minutes before tour start time.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the Millennium Park Bike Rental shop on the northeast corner of the park near Randolph Street. Look for the guide in a bright yellow cycling jersey. Please arrive 20 minutes before departure time for bike fitting.",
      contactNumber: "+1 312-555-7629",
      contactEmail: "bikes@chicagotours.com"
    },
    availableDates: [
      "2024-04-15", "2024-04-22", "2024-04-29",
