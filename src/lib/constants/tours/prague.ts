...
export const pragueTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet in front of St. Vitus Cathedral in the Second Courtyard of Prague Castle. Your guide will be holding a lantern with the Paragon Trails logo.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "We recommend comfortable walking shoes as the castle complex includes cobblestone courtyards and stairs. Evening temperatures can be cool, especially in spring and fall, so layers are advisable. The castle maintains a respectful atmosphere, so modest attire is appreciated."
      }
    ]
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the main entrance to Letná Beer Garden. Your guide will be wearing a beer-themed t-shirt and holding a Paragon Trails sign.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "The tour involves approximately 2-3 km (1.2-1.9 miles) of total walking, spread out between brewery locations. We may also take public transportation for one section. The pace is leisurely with plenty of sitting time at each brewery. Comfortable walking shoes are recommended."
      }
    ]
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet outside the entrance to the Meet Factory art center. Your guide will be wearing a colorful artist's scarf and holding a sketchbook.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Not at all! Our guides make art accessible and interesting for everyone, regardless of your background knowledge. We focus on the stories behind the art and artists, providing context that helps you appreciate Prague's creative culture in a new way."
      }
    ]
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the entrance to the Spanish Synagogue. Your guide will be holding a blue folder with the Star of David symbol.",
      contactNumber: "+420 777 456 789",
      contactEmail: "jewishprague@paragontrails.com",
    },
    
    availableDates: [
      "2023-12-14", "2023-12-18", "2023-12-21", "2023-12-28", 
      "2024-01-04", "2024-01-08", "2024-01-11", "2024-01-18", "2024-01-22", "2024-01-25", 
      "2024-02-01", "2024-02-05", "2024-02-08", "2024-02-15", "2024-02-19", "2024-02-22"
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, as these are religious sites, modest dress is required. Men must wear a head covering (kippah/yarmulke provided at entrance) and both men and women should have shoulders and knees covered. Very casual attire such as shorts or sleeveless tops may be considered disrespectful."
      }
    ]
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the entrance to the Museum of Communism. Your guide will be holding a vintage red star symbol.",
      contactNumber: "+420 777 567 890",
      contactEmail: "coldwarprague@paragontrails.com",
    },
    
    availableDates: [
      "2023-12-15", "2023-12-19", "2023-12-22", "2023-12-29", 
      "2024-01-05", "2024-01-09", "2024-01-12", "2024-01-19", "2024-01-23", "2024-01-26", 
      "2024-02-02", "2024-02-06", "2024-02-09", "2024-02-16", "2024-02-20", "2024-02-23"
    ],
    ...
    faqs: [
      {
        ...
        answer: "Yes, we visit an authentic underground nuclear bunker built during the Cold War. You'll see original equipment including gas masks, radiation suits, and communication devices. The bunker is accessed via stairs with no elevator access available."
      },
      {
        question: "Is this tour political in nature?",
        answer: "While this tour discusses political history, it presents factual information about the communist period rather than promoting any particular viewpoint. Our guides share personal experiences and historical context to help visitors understand this important era in Czech history."
      },
      {
        question: "How physically demanding is the tour?",
        answer: "This tour involves approximately 3 km (1.9 miles) of walking plus stairs to access the bunker. There is one flight of stairs with about 20 steps to enter the underground facility. We use public transportation for one segment. The pace is moderate with regular stops."
      }
    ]
  },
];
