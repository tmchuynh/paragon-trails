...
export const fijiTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the Awesome Adventures Fiji check-in counter at Port Denarau Marina. Please arrive 90 minutes before departure to complete check-in procedures and receive your boarding passes.",
    ...
    cancellationPolicy: "Full refund if canceled 30 days before the scheduled tour. 50% refund if canceled 15-29 days in advance. No refund for cancellations less than 15 days before tour start date.",
    faqs: [
      {
      ...
      },
      {
        ...
        answer: "A moderate fitness level is recommended as activities include swimming, snorkeling, hiking, and water sports. However, all activities are optional, and you can choose your level of participation. The island terrain can be uneven and some bures may require climbing steps."
      },
      {
        question: "Is there electricity and Wi-Fi on the islands?",
        answer: "Most islands have electricity, typically via generators operating during specific hours (usually 6-10 PM). Wi-Fi is limited or unavailable on more remote islands, offering a perfect digital detox. We recommend bringing portable chargers for electronic devices and adapters for Fiji's power outlets (same as Australia/New Zealand)."
      }
    ]
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet our representative at Nadi International Airport arrivals hall for transfer to Navala Village. Please look for a driver holding a sign with 'Paragon Cultural Immersion' written on it. Transfer departure is at 10:00 AM.",
    ...
    cancellationPolicy: "Full refund if canceled 21 days before the scheduled tour. 50% refund if canceled 14-20 days in advance. No refund for cancellations less than 14 days before tour start date.",
    faqs: [
      {
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the Conservation Center at Jean-Michel Cousteau Resort. Transportation from Savusavu Airport to the resort is included - our representative will meet you at arrivals. Please provide flight details at least 7 days before arrival.",
    ...
    cancellationPolicy: "Full refund if canceled 60 days before the scheduled program. 50% refund if canceled 30-59 days in advance. No refund for cancellations less than 30 days before program start date.",
    faqs: [
      {
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "VIP meet and greet at Nadi International Airport upon arrival. You will be escorted to private helicopter or luxury yacht transfer directly to the island (transfer method of your choice). Please provide flight details at time of booking.",
      contactNumber: "+679 888 1234",
      contactEmail: "luxury@paragontrails.com"
    },
    availableDates: [
      "2024-04-05", "2024-04-19",
      "2024-05-03", "2024-05-17", "2024-05-31",
    ...
    cancellationPolicy: "Full refund if canceled 90 days before arrival. 75% refund if canceled 60-89 days before arrival. 50% refund if canceled 30-59 days before arrival. No refund for cancellations less than 30 days before scheduled arrival.",
    faqs: [
      {
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the Activities Center at Outrigger Fiji Beach Resort. Airport transfers from Nadi International Airport can be arranged for an additional fee. Please inform us of your arrival details if transfer is required.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "This package is moderately physically demanding. Participants should be in good physical condition, able to swim confidently, and comfortable with heights and fast-moving water. Each day typically involves 3-5 hours of activity with appropriate breaks. While the activities are exciting, safety is our priority and professional guides ensure all adventures are appropriate for your ability level."
      },
      {
        question: "What happens if weather conditions prevent certain activities?",
        answer: "Fiji's tropical climate occasionally brings weather that may affect certain activities. If an activity cannot proceed safely due to weather, we'll substitute with an alternative adventure or reschedule for another day during your stay when possible. No refunds are provided for weather-related schedule changes as long as alternative activities are offered."
      }
    ]
  }
];
