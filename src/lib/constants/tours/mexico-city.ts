...
export const mexicoCityTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the flagpole in the center of Zócalo main square. Your guide will be holding a sign with 'Teotihuacan Tour' written on it.",
  ...
  },
  {
    ...
    meetingPoint: {
      address:
        "Frida Kahlo Museum, Londres 247, Del Carmen, Coyoacán, Mexico City",
      coordinates: {
        latitude: 19.3554,
        longitude: -99.1627,
      },
      instructions:
        "Meet outside the main entrance to the Frida Kahlo Museum (Casa Azul). Your guide will be holding a clipboard with a Frida Kahlo image.",
    ...
    faqs: [
      ...
      {
        question:
          "Will the tour still operate on days when the Casa Azul is particularly busy?",
        answer:
  ...
  },
  {
    ...
    meetingPoint: {
      address:
        "Palacio de Bellas Artes, Av. Juárez, Centro Histórico, Mexico City",
      coordinates: {
        latitude: 19.4352,
        longitude: -99.141,
      },
      instructions:
        "Meet at the main entrance steps of Palacio de Bellas Artes. Your guide will be holding a red umbrella with 'Food Tour' written on it.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the northwest corner of Zócalo main square, near the Metropolitan Cathedral entrance. Your guide will be holding a sign with 'Nightlife Tour' written on it.",
  ...
  },
  {
    ...
    meetingPoint: {
      address:
        "Museo Nacional de Antropología, Paseo de la Reforma, Mexico City",
      coordinates: {
        latitude: 19.426,
        longitude: -99.1865,
      },
      instructions:
        "Meet at the main entrance fountain of the National Anthropology Museum. Your guide will be holding a sign with 'Xochimilco Tour' written on it.",
