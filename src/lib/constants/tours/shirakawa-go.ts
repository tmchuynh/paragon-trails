...
export const shirakawaGoTours: Tour[] = [
  {
    ...
    meetingPoint: {
      address:
        "Shirakawa-go Tourist Information Center, 337 Ogimachi, Shirakawa",
      coordinates: {
        latitude: 36.2599,
        longitude: 136.9041,
      },
      instructions:
        "Meet outside the main entrance of the Shirakawa-go Tourist Information Center. Your guide will be holding a sign with 'Gassho Village Tour'.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Photography is generally permitted in the village and outside the houses. Inside the Wada House and museums, some areas may have photography restrictions which your guide will clearly indicate. Flash photography is not permitted inside any of the historic structures.",
      },
      {
        question: "How much walking is involved?",
        answer:
          "This tour involves approximately 2-3 km (1.2-1.8 miles) of walking on village paths that may be uneven in places. In winter, paths can be snowy or icy. Comfortable walking shoes are strongly recommended.",
      },
    ],
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the bus terminal parking lot. Your photography guide will be waiting with a sign reading 'Photo Tour'.",
    ...
    cancellationPolicy:
      "Full refund if canceled 72 hours in advance. 50% refund if canceled 48-72 hours in advance. No refund for cancellations less than 48 hours before scheduled tour. Alternative date offered in case of severe weather affecting photography conditions.",
    isHistorical: true,
    isRomantic: true,
    isOffTheBeatenPath: true,
    isLocalExperience: true,
    ...
    faqs: [
      {
        ...
        answer:
          "This tour is suitable for all camera types from smartphones to professional DSLRs. For best results, we recommend a camera with manual settings and interchangeable lenses. A wide-angle lens (16-35mm equivalent) is useful for village scenes, while a medium telephoto (70-200mm equivalent) works well for details and distant landscapes. A tripod is recommended for low-light situations.",
      },
      {
        question: "How does the Gokayama region differ from Shirakawa-go?",
        answer:
          "While both regions feature traditional gassho-zukuri architecture, Gokayama's villages (particularly Ainokura and Suganuma) are smaller, less visited by tourists, and often considered more authentic. The houses in Gokayama tend to have steeper roof angles due to heavier snowfall in that region. From a photography perspective, Gokayama offers more intimate scenes and opportunities to capture village life without crowds.",
      },
      {
        question: "What if weather conditions are poor?",
        answer:
          "Photography is possible in various weather conditions, and foggy or snowy days can create atmospheric images. In case of heavy rain or severe weather that would significantly impact the quality of photography, we offer the option to reschedule or receive a partial refund. Your guide will make adjustments to the itinerary based on lighting conditions on the day.",
      },
    ],
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the entrance of the Shirakawa-go Heritage Center. Your guide will be holding a sign with 'Craft Workshop Tour'.",
    ...
    faqs: [
      {
        ...
        answer:
          "Each workshop offers a different experience: Washi papermaking involves creating delicate Japanese paper using traditional fiber methods. Mochi pounding is an energetic, interactive experience making sweet rice cakes. Sarubobo doll making creates a traditional amulet unique to this region. All workshops are suitable for beginners, and your completed craft will be yours to keep.",
      },
      {
        question: "What will be served for lunch?",
        answer:
          "Lunch features local specialties such as hoba miso (miso grilled on a magnolia leaf), sansai mountain vegetables, homemade tofu, and seasonal dishes. The meal is prepared by local families using traditional methods and ingredients. Vegetarian options are available with advance notice.",
      },
      {
        question: "Is this workshop suitable for children?",
        answer:
          "Yes, children aged 6 and above can participate in all workshops. The sarubobo doll making is particularly suitable for younger children. Parents should accompany children under 12 years old.",
      },
    ],
  },
];
