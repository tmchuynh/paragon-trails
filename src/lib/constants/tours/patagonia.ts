...
export const patagoniaTours: Tour[] = [
  ...
  {
    title: "Gaucho Experience & Traditional Estancia Stay",
    description:
      "Live the authentic Patagonian gaucho lifestyle at a working sheep estancia. Join traditional horseback cattle drives, learn lasso techniques, enjoy asado barbecues, and hear folkloric stories around the campfire while staying in a historic ranch house with stunning views of the Andes.",
    images: [
      "/images/tours/patagonia/gaucho-horseback.jpg",
      "/images/tours/patagonia/estancia.jpg",
    ],
    duration: "2 days",
    price: "$490",
    rating: 4.8,
    tags: ["Gaucho", "Horseback Riding", "Cultural"],
    isFamilyFriendly: true,
    isHistorical: false,
    isRomantic: true,
    isOffTheBeatenPath: true,
    isLocalExperience: true,
    tourGuide: "Roberto Gonzalez",
    tourCategoryId: "cultural",
    faqs: [
      {
        question: "Do I need horseback riding experience?",
        answer:
          "The experience is tailored to all riding levels, from beginners to experienced equestrians. Novice riders receive basic instruction and gentle horses, participating in shorter, easier rides, while experienced riders can join more extended activities like cattle herding. The gauchos are excellent teachers who prioritize safety while ensuring everyone can participate in this fundamental aspect of Patagonian culture.",
      },
    ],
  },
  {
