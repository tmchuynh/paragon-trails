...
export const patagoniaTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at our office in downtown Puerto Natales at 8:00 AM. Please arrive 15 minutes early for equipment check and briefing. Look for the building with the mountain logo.",
  ...
  },
  {
    ...
    meetingPoint: {
      address: "Hielo & Aventura Office, Av. del Libertador 935, El Calafate, Argentina",
      coordinates: {
        latitude: -50.3407,
        longitude: -72.2648,
      },
      instructions: "Meet at the Hielo & Aventura office in downtown El Calafate at 7:15 AM. The office is located on the main avenue and has a large glacier photo in the window.",
      contactNumber: "+54 2902 491842",
      contactEmail: "peritomoreno@paragontrails.com",
    },
    
    availableDates: [
      "2023-12-15", "2023-12-16", "2023-12-17", "2023-12-18", "2023-12-19", "2023-12-20", "2023-12-21", "2023-12-22", 
      "2023-12-23", "2023-12-24", "2023-12-26", "2023-12-27", "2023-12-28", "2023-12-29", "2023-12-30", "2023-12-31",
      "2024-01-02", "2024-01-03", "2024-01-04", "2024-01-05", "2024-01-06", "2024-01-07", "2024-01-08", "2024-01-09", 
      "2024-01-10", "2024-01-11", "2024-01-12", "2024-01-13", "2024-01-14", "2024-01-15", "2024-01-16", "2024-01-17", 
      "2024-01-18", "2024-01-19", "2024-01-20", "2024-01-21", "2024-01-22", "2024-01-23", "2024-01-24", "2024-01-25", 
      "2024-01-26", "2024-01-27", "2024-01-28", "2024-01-29", "2024-01-30", "2024-01-31",
      "2024-02-01", "2024-02-02", "2024-02-03", "2024-02-04", "2024-02-05", "2024-02-06", "2024-02-07", "2024-02-08", 
      "2024-02-09", "2024-02-10", "2024-02-11", "2024-02-12", "2024-02-13", "2024-02-14", "2024-02-15", "2024-02-16", 
      "2024-02-17", "2024-02-18", "2024-02-19", "2024-02-20", "2024-02-21", "2024-02-22", "2024-02-23", "2024-02-24", 
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet in the hotel lobby at 5:00 AM for morning safaris. Your guide will be wearing a green Paragon Trails vest and carrying professional binoculars.",
  ...
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the central plaza by the monument. Transportation to the estancia will depart at 9:00 AM sharp. Look for our guide with a Paragon Trails sign.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "We recommend comfortable clothing suitable for outdoor activities, including long pants for riding (jeans or similar), closed sturdy shoes or boots, layers for changing weather (including waterproof jacket), sunscreen, hat, and gloves. Nights can be cool even in summer, so bring a warm layer. Riding helmets are provided but you're welcome to bring your own if preferred. A small day pack for personal items during activities is useful, as are personal water bottles and camera."
      }
    ]
  },
  {
    ...
    meetingPoint: {
      ...
      instructions: "Meet at the main tourist pier information booth. Your guide will be holding a 'Tierra del Fuego Explorer' sign. Please arrive 15 minutes before departure.",
