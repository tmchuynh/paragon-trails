...
export const singaporeTours: Tour[] = [
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the main entrance to Gardens by the Bay (near Bayfront MRT Exit B). Look for guide holding a green 'Singapore Explorer' sign.",
    ...
    faqs: [
      {
        ...
        answer:
          "Comfortable walking shoes and lightweight clothing are recommended. Both conservatories are air-conditioned, so bringing a light sweater might be comfortable for some visitors.",
      },
      {
        question: "Is photography allowed?",
        answer:
          "Yes, photography is permitted throughout Gardens by the Bay and at the Marina Bay Sands Skypark. Tripods are not allowed in the conservatories or at the Skypark.",
      },
      {
        question: "What happens in case of rain?",
        answer:
          "This tour operates rain or shine. Much of the tour takes place in covered or indoor areas. Umbrellas can be purchased at Gardens by the Bay if needed.",
      },
    ],
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet outside Exit A of Bugis MRT station. Look for guide holding a red umbrella with 'Singapore Food Tours' printed on it.",
    ...
    faqs: [
      {
        ...
        answer:
          "Dishes typically include Singaporean classics like Hainanese chicken rice, laksa, char kway teow, satay, roti prata, and chili crab (subject to availability). We also try local desserts like ice kacang or cendol.",
      },
      {
        question: "Can dietary restrictions be accommodated?",
        answer:
          "Yes, we can accommodate vegetarian, halal, and most other dietary restrictions with advance notice. Please inform us of your dietary needs when booking so we can arrange suitable alternatives.",
      },
      {
        question: "How spicy is the food?",
        answer:
          "Singaporean cuisine spans a range of spice levels. Your guide will point out which dishes are spicy and can recommend milder options for those sensitive to heat. Most hawker stalls can adjust spice levels upon request.",
      },
    ],
  },
  {
    ...
    meetingPoint: {
      ...
      instructions:
        "Meet at the Night Safari entrance plaza. Look for the guide holding an illuminated sign with 'Singapore Night Safari Tour' written on it.",
    ...
    faqs: [
      {
        ...
        answer:
          "The Night Safari is home to over 900 animals representing 100 species, including many threatened species. You'll likely see Asian elephants, fishing cats, leopards, lions, tigers, giant flying squirrels, and various nocturnal creatures.",
      },
      {
        question: "Is photography allowed?",
        answer:
          "Photography is permitted but without flash as this disturbs the animals. The lighting conditions are designed to mimic moonlight, so professional cameras with high ISO capabilities work best.",
      },
      {
        question: "Is this tour suitable for young children?",
        answer:
          "Yes, children of all ages enjoy the Night Safari. However, some young children might find certain sections a bit dark or intimidating. The tram ride is suitable for all ages.",
      },
    ],
  },
];
