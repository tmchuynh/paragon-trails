...
export const tourGuides: TourGuide[] = [
  ...
  },
  {
    ...
    description:
      "Dr. Giordano specializes in Florence's secret history, guiding guests through hidden passages and lesser-known stories of the Medici family.",
    quote:
      "Florence is a city of secrets, and I am here to help you uncover them.",
  ...
  },
  {
    ...
    description:
      "A certified sommelier and culinary expert, Marco takes guests on a gastronomic journey through Tuscany, from vineyard tours to traditional farmhouse lunches.",
    quote:
      "Tuscany is not just a place; it's a flavor, a feeling, and a way of life.",
