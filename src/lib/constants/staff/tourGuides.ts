...
export const tourGuides: TourGuide[] = [
  ...
  },
  {
    ...
    bio: "Hans is a Berlin native with a deep passion for his city's history and culture. He studied history and political science at the Free University of Berlin and has worked as a tour guide for over a decade. Hans combines his extensive knowledge of Berlin's history with his love for storytelling, making each tour a unique experience. He is also a talented photographer, and his tours provide guests with unique opportunities to capture the beauty and history of Berlin. Hans collaborates with local artists and historians to create specialized tours that delve into specific aspects of Berlin's history, such as the Cold War, the fall of the Berlin Wall, and the city's vibrant art scene. His tours often include exclusive access to art studios, galleries, and historical sites that are not normally open to the public.",
    quote:
      "Berlin isn't just a city—it's a living timeline where every graffiti tag and restored building tells a story of division and reunification.",
  },
  {
    city: "Bangkok",
    name: "Maya",
  ...
  },
  {
    ...
    description:
      "Eva is a passionate guide who specializes in Prague’s gothic architecture and folklore, bringing the city’s legends and landmarks vividly to life.",
    bio: "A lover of gothic architecture and folklore, Eva’s tours bring the city’s legends and landmarks vividly to life. She has a degree in Art History from Charles University and has worked as a tour guide for over eight years. Eva combines her extensive knowledge of Prague's history with her love for storytelling, making each tour a unique experience. Her tours often include exclusive access to hidden gems and lesser-known sites, providing guests with a deeper understanding of the city's rich cultural heritage. Eva is also a talented writer, and her articles on Prague's history and culture have been published in several international magazines. She collaborates with local artists and historians to create specialized tours that delve into specific aspects of Prague's history, such as the city's medieval past, its role in the Habsburg Empire, and its vibrant contemporary art scene.",
    quote:
      "Prague is a city of stories, where every cobblestone whispers secrets of the past.",
    certifications: ["Certified Prague Guide"],
  },
  {
    city: "Buenos Aires",
    name: "Tomás",
  ...
  },
  {
    ...
    experienceYears: 9,
    specialties: ["Cultural Heritage", "Food Tours", "City Tours"],
  ...
  },
  {
    ...
    experienceYears: 9,
    specialties: ["Cultural Heritage", "Historical Tours", "City Tours"],
    bio: "Elif, an Istanbul native, offers tours that explore the city’s rich cultural heritage, historical landmarks, and vibrant neighborhoods. She has a degree in Cultural Studies from Boğaziçi University and has worked as a tour guide for over nine years. Elif combines her extensive knowledge of Istanbul's history with her love for storytelling, making each tour a unique experience. Her tours often include exclusive access to historical sites and cultural experiences, providing guests with an immersive cultural journey.",
    description:
      "Elif, an Istanbul native, offers tours that explore the city’s rich cultural heritage, historical landmarks, and vibrant neighborhoods.",
    quote:
