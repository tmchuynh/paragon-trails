...
export const belgradeTourGuides: TourGuide[] = [
  {
    city: "Belgrade",
    country: "Serbia",
    name: "Miloš Petrović",
  ...
  },
  {
    ...
    languages: ["Serbian", "English", "German"],
    experienceYears: 5,
    specialties: ["Romantic Tours", "Cultural Experiences", "Nightlife Tours"],
    bio: "Jovana, a Belgrade native, offers tours that explore the city’s romantic spots, cultural experiences, and nightlife. She has a degree in Cultural Studies from the University of Belgrade and has worked as a tour guide for over five years. Jovana combines her extensive knowledge of Belgrade's culture with her love for storytelling, making each tour a unique experience. Her tours often include exclusive access to romantic spots, cultural experiences, and nightlife offerings, providing guests with an immersive cultural journey.",
    description:
      "Jovana, a Belgrade native, offers tours that explore the city’s romantic spots, cultural experiences, and nightlife.",
    quote:
      "In Belgrade, every night is a celebration of love, and every meal is a taste of Serbia’s vibrant spirit.",
    profileImage: "/images/guides/valeria-marino.jpg",
  },
