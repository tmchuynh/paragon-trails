...
export const buenosAiresTourGuides: TourGuide[] = [
  {
    city: "Buenos Aires",
    country: "Argentina",
    ...
    bio: "Lucia brings Buenos Aires to life with her deep knowledge of its history and culture, offering engaging tours that highlight the city's iconic landmarks and hidden gems. Her storytelling skills and passion for the city's heritage make her tours both educational and entertaining. Lucia's tours often include exclusive access to historical sites, local markets, and cultural events, ensuring guests experience the authentic spirit of Buenos Aires.",
    description:
      "Lucia's tours uncover the vibrant history and cultural essence of Buenos Aires, blending storytelling with exploration.",
    quote:
  ...
  },
  {
    ...
    bio: "Sofía's passion for Buenos Aires shines through her tours, which delve into the city's culinary traditions and historical narratives. Her tours are carefully curated to provide guests with an immersive experience, combining visits to historical landmarks with tastings of local cuisine. Sofía's warm personality and deep knowledge of the city's culture make her tours unforgettable.",
    description:
      "Sofía offers a unique perspective on Buenos Aires, combining its rich history with its vibrant culinary scene.",
    quote:
  ...
  },
  {
    ...
    bio: "Tomás immerses guests in the rhythm of Buenos Aires, blending tango culture with captivating historical tales. His tours are a celebration of the city's vibrant spirit, offering guests a chance to learn about its history while experiencing its iconic dance form. Tomás collaborates with local tango schools and performers to provide exclusive access to workshops and shows, making his tours truly unique.",
    description:
      "Tomás' tours celebrate the spirit of Buenos Aires through dance and storytelling, creating unforgettable experiences.",
    quote:
  ...
  },
  {
    ...
    bio: "Diego's tours provide a deep dive into Buenos Aires' historical evolution, showcasing its cultural richness and modern charm. With a background in history and a passion for storytelling, Diego crafts tours that explore the city's transformation over the centuries. His tours often include visits to museums, historical landmarks, and local markets, offering guests a comprehensive view of Buenos Aires' heritage.",
    description:
      "Diego explores the layers of Buenos Aires' history, offering a blend of cultural heritage and contemporary experiences.",
    quote:
