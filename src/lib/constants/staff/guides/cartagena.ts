...
export const cartagenacolombiacaribbeanGuides: TourGuide[] = [
  ...
  },
  {
    ...
    specialties: ["Parks & Gardens", "Local Cuisine", "Architecture"],
  ...
  },
  {
    ...
    region: "Caribbean",
    isPopular: true,
    bio: "Alexander is a passionate tour guide with extensive knowledge of Cartagena and Colombia. Specializing in Photography Spots, Urban Legends, Historical Landmarks, Alexander provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["South America", "East Coast Canada"],
    tourTypes: ["Cruise Excursion", "Nature Tour"],
    maxGroupSize: 10,
    ...
    specialties: ["Photography Spots", "Urban Legends", "Historical Landmarks"],
