...
export const victoriacanadaalaskaGuides: TourGuide[] = [
  ...
  },
  {
    ...
    region: "Alaska",
    isPopular: true,
    bio: "Owen is a passionate tour guide with extensive knowledge of Victoria and Canada. Specializing in Art Galleries, Historical Landmarks, Owen provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Northern Europe", "Africa"],
    tourTypes: ["Luxury Tour", "Photography Tour", "Market Tour", "Off-Road Tour"],
    maxGroupSize: 19,
    licenseNumber: "LIC-5241-VIC",
    phoneNumber: "+1-675-341-7573",
    contactEmail: "owen.campbell@paragontrails.com",
    available: [
      {
        day: "Tuesday",
        availableHours: [
    ...
    isCertified: true,
    description: "Owen is a passionate tour guide with extensive knowledge of Victoria and Canada. Specializing in Art Galleries, Historical Landmarks, Owen provides authentic and engaging experiences for visitors of all backgrounds.",
    rating: 3.8,
    reviewsCount: 33,
    quote: "In Victoria, we don't just see the sights - we make memories.",
    ...
    specialties: ["Art Galleries", "Historical Landmarks"],
    specialTraining: [],
  },
  {
    id: "guide-victoria-5",
    ...
    region: "Alaska",
    isPopular: false,
    bio: "Henry is a passionate tour guide with extensive knowledge of Victoria and Canada. Specializing in Photography Spots, Historical Landmarks, Sustainable Tourism, Henry provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["East Coast Canada"],
    tourTypes: ["Architecture Tour", "Farm Visit", "Market Tour", "Boat Tour"],
    maxGroupSize: 19,
    licenseNumber: "LIC-5989-VIC",
    phoneNumber: "+1-213-243-3064",
    ...
    isCertified: true,
    description: "Henry is a passionate tour guide with extensive knowledge of Victoria and Canada. Specializing in Photography Spots, Historical Landmarks, Sustainable Tourism, Henry provides authentic and engaging experiences for visitors of all backgrounds.",
    rating: 4.4,
    reviewsCount: 57,
    ...
    specialties: ["Photography Spots", "Historical Landmarks", "Sustainable Tourism"],
  ...
  },
  {
    ...
    region: "Alaska",
    isPopular: false,
    bio: "Matthew is a passionate tour guide with extensive knowledge of Victoria and Canada. Specializing in Local Cuisine, Photography Spots, Architecture, Art Galleries, Matthew provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["East Coast USA", "Middle East"],
    tourTypes: ["Nature Tour", "Underground Tour", "Ghost Tour", "Family-Friendly Tour"],
    maxGroupSize: 18,
    licenseNumber: "LIC-9228-VIC",
    phoneNumber: "+1-566-546-3774",
    ...
    isCertified: true,
    description: "Matthew is a passionate tour guide with extensive knowledge of Victoria and Canada. Specializing in Local Cuisine, Photography Spots, Architecture, Art Galleries, Matthew provides authentic and engaging experiences for visitors of all backgrounds.",
    rating: 4.1,
    reviewsCount: 94,
    quote: "The best way to discover Victoria is with someone who lives and breathes its culture.",
    ...
    specialties: ["Local Cuisine", "Photography Spots", "Architecture", "Art Galleries"],
