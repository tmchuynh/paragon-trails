...
export const capeTownsouthAfricaafricaGuides: TourGuide[] = [
  ...
  },
  {
    ...
    region: "Africa",
    isPopular: false,
    bio: "Benjamin is a passionate tour guide with extensive knowledge of Cape Town and South Africa. Specializing in Historical Landmarks, Benjamin provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Mediterranean"],
    tourTypes: ["Religious Tour", "Group Tour", "Cultural Tour"],
    maxGroupSize: 7,
    licenseNumber: "LIC-6390-CAP",
    phoneNumber: "+1-104-345-1169",
    contactEmail: "benjamin.thomas@paragontrails.com",
    available: [
      {
        day: "Friday",
        availableHours: [
  ...
  },
  {
    ...
    contactEmail: "owen.clark@paragontrails.com",
    available: [
      {
        day: "Wednesday",
        availableHours: [
  ...
  },
  {
    ...
    contactEmail: "harper.rivera@paragontrails.com",
    available: [
      {
        day: "Thursday",
        availableHours: [
