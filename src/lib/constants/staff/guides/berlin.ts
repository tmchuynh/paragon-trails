...
export const berlingermanynorthernEuropeGuides: TourGuide[] = [
  {
    ...
    isPopular: true,
    bio: "Ava is a passionate tour guide with extensive knowledge of Berlin and Germany. Specializing in Street Food, Ava provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["West Coast USA"],
    tourTypes: ["Private Tour", "Market Tour", "Luxury Tour", "Cooking Class"],
    maxGroupSize: 9,
    licenseNumber: "LIC-3602-BER",
    phoneNumber: "+1-872-570-2546",
  ...
  },
  {
    ...
    specialties: ["Wildlife", "Film Locations", "Music Scene"],
  ...
  },
  {
    ...
    region: "Northern Europe",
    isPopular: false,
    bio: "Daniel is a passionate tour guide with extensive knowledge of Berlin and Germany. Specializing in Wine Tasting, Family Activities, Architecture, Religious Sites, Daniel provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Mediterranean"],
    tourTypes: ["Farm Visit", "Market Tour", "Walking Tour"],
    maxGroupSize: 16,
    licenseNumber: "LIC-7885-BER",
    phoneNumber: "+1-829-657-7633",
