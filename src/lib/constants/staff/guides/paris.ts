...
export const parisfrancenorthernEuropeGuides: TourGuide[] = [
  ...
  },
  {
    ...
    region: "Northern Europe",
    isPopular: false,
    bio: "Scarlett is a passionate tour guide with extensive knowledge of Paris and France. Specializing in Local Markets, Adventure Sports, Music Scene, Scarlett provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["South America"],
    tourTypes: ["Market Tour", "Wildlife Safari", "Nature Tour"],
    maxGroupSize: 16,
    licenseNumber: "LIC-4082-PAR",
    phoneNumber: "+1-147-302-8416",
  ...
  },
  {
    ...
    contactEmail: "william.torres@paragontrails.com",
    available: [
      {
        day: "Friday",
        availableHours: [
    ...
    languages: ["Italian", "Arabic", "Croatian"],
    experienceYears: 11,
    certifications: ["Food Safety Certification"],
    specialties: ["Cultural Etiquette", "Adventure Sports"],
  ...
  },
  {
    ...
    region: "Northern Europe",
    isPopular: false,
    bio: "Evelyn is a passionate tour guide with extensive knowledge of Paris and France. Specializing in LGBTQ+ History, Evelyn provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Asia Pacific", "East Coast USA"],
    tourTypes: ["Family-Friendly Tour", "Ghost Tour"],
    maxGroupSize: 12,
    licenseNumber: "LIC-1810-PAR",
    phoneNumber: "+1-143-776-7554",
