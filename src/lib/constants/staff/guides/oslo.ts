...
export const oslonorwaynorthernEuropeGuides: TourGuide[] = [
  {
    ...
    isPopular: false,
    bio: "Abigail is a passionate tour guide with extensive knowledge of Oslo and Norway. Specializing in Music Scene, Parks & Gardens, Historical Landmarks, Sustainable Tourism, Abigail provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Africa", "East Coast Canada"],
    tourTypes: ["Self-Guided Tour", "Historical Tour"],
    maxGroupSize: 14,
    licenseNumber: "LIC-3510-OSL",
    phoneNumber: "+1-783-288-5918",
  ...
  },
  {
    ...
    region: "Northern Europe",
    isPopular: true,
    bio: "Ethan is a passionate tour guide with extensive knowledge of Oslo and Norway. Specializing in LGBTQ+ History, Historical Landmarks, Local Craftsmanship, Ethan provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Northern Europe", "Middle East"],
    tourTypes: ["Romantic Tour", "Nature Tour", "Museum Tour"],
    maxGroupSize: 13,
    licenseNumber: "LIC-4137-OSL",
    phoneNumber: "+1-140-381-2333",
  ...
  },
  {
    ...
    languages: ["German", "Korean", "Tagalog"],
    experienceYears: 10,
    certifications: ["Adventure Tourism Safety Certificate"],
    specialties: ["Street Food", "Museums", "Nightlife", "Religious Sites"],
  ...
  },
  {
    ...
    languages: ["Bulgarian", "German", "Czech"],
    experienceYears: 11,
  ...
  },
  {
    ...
    region: "Northern Europe",
    isPopular: false,
    bio: "Wyatt is a passionate tour guide with extensive knowledge of Oslo and Norway. Specializing in Wildlife, Wyatt provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Mediterranean", "Asia Pacific"],
    tourTypes: ["Architecture Tour", "Helicopter Tour"],
    maxGroupSize: 19,
    licenseNumber: "LIC-1682-OSL",
    phoneNumber: "+1-159-399-4673",
    contactEmail: "wyatt.scott@paragontrails.com",
    available: [
      {
        day: "Friday",
        availableHours: [
  ...
  },
  {
    ...
    region: "Northern Europe",
    isPopular: true,
    bio: "Isabella is a passionate tour guide with extensive knowledge of Oslo and Norway. Specializing in Local Craftsmanship, Isabella provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Mediterranean", "East Coast USA"],
    tourTypes: ["Cruise Excursion", "Market Tour"],
    maxGroupSize: 16,
    licenseNumber: "LIC-5540-OSL",
    phoneNumber: "+1-962-915-5326",
    contactEmail: "isabella.campbell@paragontrails.com",
    available: [
      {
        day: "Wednesday",
        availableHours: [
