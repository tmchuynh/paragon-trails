...
export const rioDeJaneirobrazilsouthAmericaGuides: TourGuide[] = [
  {
    ...
    contactEmail: "scarlett.adams@paragontrails.com",
    available: [
      {
        day: "Friday",
        availableHours: [
  ...
  },
  {
    ...
    contactEmail: "jackson.hall@paragontrails.com",
    available: [
      {
        day: "Tuesday",
        availableHours: [
  ...
  },
  {
    ...
    region: "South America",
    isPopular: true,
    bio: "Emma is a passionate tour guide with extensive knowledge of rio-de-janeiro and Brazil. Specializing in Museums, Music Scene, Architecture, Wine Tasting, Emma provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Asia Pacific", "Alaska"],
    tourTypes: ["Photography Tour", "Wine Tour", "Museum Tour"],
    maxGroupSize: 14,
    licenseNumber: "LIC-9840-RIO",
    phoneNumber: "+1-863-203-6968",
    contactEmail: "emma.wright@paragontrails.com",
    available: [
      {
        day: "Monday",
        availableHours: [
