...
export const lisbonportugalmediterraneanGuides: TourGuide[] = [
  ...
  },
  {
    ...
    region: "Mediterranean",
    isPopular: false,
    bio: "Zoe is a passionate tour guide with extensive knowledge of Lisbon and Portugal. Specializing in Wine Tasting, Zoe provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["East Coast USA"],
    tourTypes: ["Museum Tour", "Nature Tour", "Photography Tour", "Group Tour"],
    maxGroupSize: 7,
