...
export const bostonunitedStateseastCoastUsaGuides: TourGuide[] = [
  ...
  },
  {
    ...
    contactEmail: "zoe.lopez@paragontrails.com",
    available: [
      {
        day: "Sunday",
        availableHours: [
    ...
    specialties: ["Parks & Gardens", "Religious Sites", "Photography Spots"],
  ...
  },
  {
    ...
    region: "East Coast USA",
    isPopular: false,
    bio: "Madison is a passionate tour guide with extensive knowledge of Boston and United States. Specializing in Art Galleries, Local Cuisine, Madison provides authentic and engaging experiences for visitors of all backgrounds.",
    regionsCovered: ["Middle East"],
    tourTypes: ["Cooking Class", "Helicopter Tour", "Adventure Tour"],
    maxGroupSize: 17,
    licenseNumber: "LIC-8799-BOS",
    phoneNumber: "+1-278-585-9148",
  ...
  },
  {
    ...
    contactEmail: "james.adams@paragontrails.com",
    available: [
      {
        day: "Friday",
        availableHours: [
