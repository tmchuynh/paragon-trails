...
export const heritageHouseRooms: RoomOption[] = [
  {
    ...
    description:
      "Relax in our homey soothing queen loft featuring where the horizon meets the ocean, along with with high-speed internet access and with rustic and modern influences.",
    occupancy: {
      adults: 2,
      children: 0,
      maxGuests: 2,
