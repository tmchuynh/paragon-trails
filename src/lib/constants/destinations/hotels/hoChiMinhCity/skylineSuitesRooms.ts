...
export const skylineSuitesRooms: RoomOption[] = [
  {
    ...
    description:
      "Indulge in the refreshing atmosphere of our queen studio, with spectacular with a view of the tranquil sea, decorated with local artistic influences, and with a modern en-suite bathroom.",
    occupancy: {
      adults: 2,
      maxGuests: 2,
    },
