...
export const florenceHotels: Hotel[] = [
  {
    ...
    amenities: ["Parking", "24-Hour Front Desk", "Spa", "Restaurant", "Pet Friendly", "Business Center"],
    checkInTime: "15:00",
    checkOutTime: "10:00",
    roomsAvailable: 35,
    isPetFriendly: false,
  ...
  },
  {
    ...
    amenities: ["Room Service", "24-Hour Front Desk", "Conference Room", "Restaurant", "Business Center", "Parking", "Spa", "Fitness Center", "Non-Smoking Rooms", "Swimming Pool"],
    checkInTime: "13:00",
    checkOutTime: "10:00",
    roomsAvailable: 31,
    isPetFriendly: true,
  ...
  },
  {
    ...
    amenities: ["Free Wi-Fi", "Swimming Pool", "Conference Room", "Laundry Service", "Bar", "Fitness Center"],
