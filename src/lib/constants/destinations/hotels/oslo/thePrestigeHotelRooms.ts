...
export const thePrestigeHotelRooms: RoomOption[] = [
  {
    ...
    description: "This stretching single accommodation offers where you can enjoy the city's energy, decorated with local artistic influences.",
    occupancy: {
      adults: 1,
      maxGuests: 1,
    },
