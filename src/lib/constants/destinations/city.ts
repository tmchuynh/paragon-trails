...
export const cityattractions: CityAttractions[] = [
  ...
  },
  {
    ...
    region: "Crete",
    country: "Greece",
    subtitle: "Gateway to Minoan Civilization",
    quote:
      "Our guide's knowledge of ancient Minoan history brought Knossos Palace to life. The mix of myth and archaeology made this my favorite Greek adventure.",
  },
  {
    city: "Shanghai",
    state: "",
  ...
  },
  {
    ...
    region: "Central Vietnam",
    country: "Vietnam",
    subtitle: "City of Lanterns",
    quote:
      "Experiencing the lantern festival in Hoi An was magical - the river aglow with hundreds of floating lights. Our guide showed us the best local tailors too!",
  },
  {
    city: "Los Angeles",
    state: "CA",
  ...
  },
  {
    ...
    region: "PA",
    country: "United States",
    subtitle: "City of Brotherly Love",
    quote:
      "Our family History tour with Paragon Trails included skip-the-line access to Independence Hall and a special cheesesteak tasting competition that the kids still talk about!",
  },
  {
    city: "New Orleans",
    state: "LA",
  ...
  },
  {
    ...
    country: "Greece",
    subtitle: "Cultural Capital of Greece",
    quote:
      "Exploring Thessaloniki's Byzantine past with our expert guide was fascinating. The food tour through local markets and tavernas was an absolute culinary delight!",
  },
  {
    city: "Athens",
    state: "",
