export const cityattractions = [
    ...
    attractions: [
      {
        ...
        description: "Iconic symbols of freedom and immigration.",
      },
      {
        title: "Central Park",
        description:
          "843-acre urban oasis with lakes, trails, and cultural sites like Bethesda Terrace.",
      },
      {
        title: "Empire State Building",
        description: "Classic Art Deco skyscraper with stunning views.",
      },
      {
        title: "Broadway & Times Square",
        description:
          "World-famous theater district and neon-lit epicenter of NYC energy.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Walk across the bridge to experience skyline views and trendy shops.",
      },
      {
        title: "Museum of Modern Art (MoMA)",
        description: "Picasso, Warhol, Van Gogh, and more.",
      },
      {
        title: "Fifth Avenue",
        description: "Luxury shopping and iconic window displays.",
      },
      {
        title: "The High Line",
        description: "Elevated park built on a historic rail line.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    attractions: [
      ...
      {
        title: "Cham Museum",
        description: "Museum dedicated to Cham culture and sculptures.",
      },
      {
        title: "Non Nuoc Beach",
        description: "Scenic beach near Marble Mountains with calm waters.",
      },
      {
        title: "Asia Park",
        description:
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        description:
          "Ancient Hindu temples built by the Cham civilization overlooking the Cai River.",
      },
      {
        title: "Vinpearl Land",
        description:
          "Island amusement park with water slides, aquarium, and cable car rides.",
      },
      {
        title: "Long Son Pagoda",
        description:
          "Buddhist temple known for its large white Buddha statue on a hill.",
      },
      {
        title: "Hon Mun Island",
        description:
          "Marine protected area with coral reefs ideal for snorkeling and diving.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Museum dedicated to the life of the Swiss-French bacteriologist who worked in Vietnam.",
      },
      {
        title: "Dam Market",
        description:
  ...
  },
  {
    ...
    attractions: [
      ...
      {
        title: "Tan Ky Ancient House",
        description:
          "Historic merchant house showcasing traditional architecture and furnishings.",
      },
      {
        title: "Cua Dai Beach",
        description:
          "Popular beach known for soft sand and calm waters, just outside town.",
      },
      {
        title: "Phuc Kien Assembly Hall",
        description:
          "Historic hall built by the Fujian Chinese community with elaborate decorations.",
      },
      {
        title: "Tra Que Vegetable Village",
        description:
          "Traditional farming village known for fresh herbs and interactive tours.",
      },
      {
        title: "Museum of Trade Ceramics",
        description:
          "Exhibition of ancient ceramics highlighting the town’s maritime trade history.",
      },
      {
        title: "Hoi An Lantern Festival",
        description:
          "Monthly event where the town is illuminated by thousands of lanterns, creating a magical atmosphere.",
      },
      {
        title: "Cantonese Assembly Hall",
        description:
          "Another beautiful assembly hall built by the Cantonese community featuring intricate artwork.",
      },
    ],
  },
  {
    ...
    attractions: [
      {
        ...
        description: "Iconic views over LA and great hiking trails.",
      },
      {
        title: "Walk of Fame & TCL Chinese Theatre",
        description: "See handprints of the stars and movie premieres.",
      },
      {
        title: "Santa Monica Pier & Venice Beach",
        description:
          "Classic SoCal beach vibes with shops, food, and performers.",
      },
      {
        title: "The Getty Center",
        description:
          "Hilltop art museum with architecture, gardens, and views.",
      },
      {
        title: "Rodeo Drive",
        description: "High-end shopping in Beverly Hills.",
      },
      {
