...
export const juneaualaskaAttractions: Attraction[] = [
    {
      ...
      description: "Mendenhall Glacier - No description available.",
    ...
    },
    {
      ...
      description: "Mount Roberts Tramway - No description available.",
    ...
    },
    {
      ...
      description: "Alaska State Museum - No description available.",
