...
export const parisHomestays: Host[] = [
      {
        ...
        curfew: "13:00 AM",
        isPopular: false,
        guestPolicy: ["LGBTQ+ friendly", "Pet-friendly accommodation", "Senior-friendly accommodations", "Suitable for business travelers"],
        hostingStyle: "private",
        houseRules: ["Please conserve water and electricity", "No pets allowed", "Laundry available on weekends only", "No food in the bedrooms"],
        location: {
          city: "Paris",
      ...
      },
      {
        ...
        houseRules: ["Recycle according to local guidelines", "Respect shared spaces", "Quiet hours after 10 PM", "Laundry available on weekends only", "Remove shoes when entering the home"],
        location: {
          city: "Paris",
          region: "Northern Europe",
          country: "France",
...
,
      {
        ...
        houseRules: ["Breakfast is self-serve between 7-9 AM", "Please clean up after yourself in common areas", "Kitchen closed after 8 PM", "Lock the door when leaving the house", "Notify host if you'll be arriving after 10 PM", "No smoking indoors"],
        location: {
          city: "Paris",
          region: "Northern Europe",
          country: "France",
