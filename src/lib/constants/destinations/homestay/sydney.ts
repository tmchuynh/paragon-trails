...
export const sydneyHomestays: Host[] = [
      {
        ...
        hostingStyle: "social",
        houseRules: ["Remove shoes when entering the home", "Please clean up after yourself in common areas", "Respect shared spaces"],
        location: {
          city: "Sydney",
          region: "Asia Pacific",
          country: "Australia",
      ...
      },
      {
        ...
        houseRules: ["Breakfast is self-serve between 7-9 AM", "No pets allowed", "Lock the door when leaving the house"],
        location: {
          city: "Sydney",
          region: "Asia Pacific",
          country: "Australia",
...
,
      {
        ...
        houseRules: ["Lock the door when leaving the house", "No outside guests without permission", "Remove shoes when entering the home", "Breakfast is self-serve between 7-9 AM", "Respect shared spaces", "Kitchen closed after 8 PM"],
        location: {
          city: "Sydney",
          region: "Asia Pacific",
          country: "Australia",
