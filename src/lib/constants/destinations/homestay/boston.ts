...
export const bostonHomestays: Host[] = [
      {
        ...
        curfew: "24:00 PM",
        isPopular: false,
        guestPolicy: ["Accessible for guests with mobility issues", "LGBTQ+ friendly", "Not suitable for infants (under 2 years)", "Ideal for solo travelers"],
        hostingStyle: "private",
        houseRules: ["Please conserve water and electricity", "No smoking indoors", "Lock the door when leaving the house", "Recycle according to local guidelines", "No outside guests without permission"],
        location: {
          city: "Boston",
...
,
      {
        ...
        curfew: "24:00 PM",
        isPopular: false,
        guestPolicy: ["Not suitable for infants (under 2 years)", "No parties or events", "LGBTQ+ friendly"],
        hostingStyle: "hands-on",
        houseRules: ["Laundry available on weekends only", "Recycle according to local guidelines", "Wi-Fi password will be provided upon arrival", "No outside guests without permission"],
        location: {
          city: "Boston",
          region: "East Coast USA",
          country: "United States",
      ...
      },
      {
        ...
        curfew: "21:00 PM",
        isPopular: false,
        guestPolicy: ["Not suitable for infants (under 2 years)", "Children welcome", "LGBTQ+ friendly", "Suitable for digital nomads"],
        hostingStyle: "social",
        houseRules: ["Please conserve water and electricity", "Wi-Fi password will be provided upon arrival", "No outside guests without permission"],
        location: {
          city: "Boston",
          region: "East Coast USA",
          country: "United States",
...
,
      {
        ...
        houseRules: ["Pets welcome", "Recycle according to local guidelines", "No loud music after 9 PM", "Kitchen closed after 8 PM"],
        location: {
          city: "Boston",
          region: "East Coast USA",
          country: "United States",
