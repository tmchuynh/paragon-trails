...
export default function RentAVehicle() {
  ...
  const handleSoundSystemChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setSoundSystemFilter(e.target.value);
  };
  ...
  return (
    <div className="mx-auto pt-8 md:pt-12 lg:pt-24 w-10/12 md:w-11/12">
      ...
      <div className="bg-gray-50 dark:bg-gray-800 shadow mb-8 p-6 rounded-lg">
        <h2 className="mb-4">Filter Vehicles</h2>
        ...
        <div className="gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleSoundSystemChange}
            >
              <option value="">Any</option>
