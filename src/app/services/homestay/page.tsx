      ...
      <div className="mx-auto py-8 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <p className="mb-4 text-lg">
            A homestay is a unique form of accommodation where travelers stay in
            a local resident's home rather than a traditional hotel or rental
            property. This arrangement offers an authentic cultural experience
            by immersing guests in the everyday life, customs, and hospitality
            of the host family.
          </p>
          <p className="mb-4 text-lg">
            Unlike typical lodging options, homestays provide more than just a
            place to sleep—they offer genuine human connection, cultural
            exchange, and a deeper understanding of the destination.
          </p>
        </div>
          ...
          <div className="gap-6 grid md:grid-cols-2">
            <div className="bg-white shadow-sm p-4 border border-gray-100 rounded-lg">
              ...
              <p>
                ...
                destination as locals do—from traditional meals and home
                routines to community events and customs. It's the most
                immersive way to appreciate a culture firsthand.
              </p>
            </div>
            ...
            <div className="bg-white shadow-sm p-4 border border-gray-100 rounded-lg">
              ...
              <p>
                ...
                excellent value without sacrificing comfort. This makes
                homestays a practical choice for budget-conscious travelers who
                still want quality experiences.
              </p>
            </div>
        ...
        <section className="mb-16">
          ...
          <ul className="space-y-3 pl-6 list-disc">
            <li>
              ...
              shared common areas such as the kitchen, living room, and
              bathroom.
            </li>
            <li>
              Interaction with your hosts, who may offer meals, local advice,
              and opportunities to participate in household activities or local
              events.
            </li>
            <li>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-white shadow-sm p-5 border border-gray-100 rounded-lg">
              ...
              <p>
                Start by selecting the city or region where you want to
                experience a homestay. We offer curated host family options in a
                variety of popular and off-the-beaten-path destinations. Specify
                your travel dates to check availability, ensuring your stay
                aligns perfectly with your itinerary.
              </p>
            </div>
            ...
            <div className="bg-white shadow-sm p-5 border border-gray-100 rounded-lg">
              ...
              <p>
                ...
                cultural background, and any special offerings such as
                home-cooked meals or local activities. You can filter hosts by
                preferences such as language spoken, dietary accommodations, or
                family composition to find the best fit for your travel style
                and needs.
              </p>
            </div>
            ...
            <div className="bg-white shadow-sm p-5 border border-gray-100 rounded-lg">
              ...
              <p>
                ...
                confirmation along with all necessary check-in information.
                You'll also receive a comprehensive guide to prepare for your
                stay, including cultural etiquette, local customs, and contact
            ...
            <div className="bg-white shadow-sm p-5 border border-gray-100 rounded-lg">
              ...
              <p>
                ...
                questions or assistance. We prioritize your comfort and safety
                to ensure your experience is positive and fulfilling from start
                to finish.
              </p>
            </div>
          </div>
        ...
        {/* How to Book Section */}
        <section className="bg-gray-50 mb-16 p-6 rounded-lg">
          <h2 className="mb-4 font-semibold text-2xl">
            How to Book a Homestay
          </h2>
          <p className="mb-4">
            We facilitate homestay bookings at select destinations, ensuring
            each host meets strict standards for safety, cleanliness, and
            hospitality. When you book a homestay through us, you receive:
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="mb-4 text-lg">
            For more information about our homestay options, please contact us
            at:
          </p>
          ...
          <p className="text-lg">
            We look forward to helping you create unforgettable memories with
        ...
        <section className="mb-8 text-center">
          ...
          <p className="mb-6 text-lg">
            ...
            connections, local knowledge, and unforgettable memories. If you
            seek a travel experience that goes beyond the typical, a homestay is
            an excellent choice.
          </p>
