...
// Mock vehicle data - in a real app, this would come from an API based on the slug
...
export default function VehicleDetailPage() {
  ...
  const vehicle = mockVehicle; // In a real app, this would be fetched based on the route params
