...
import { formatCurrency, formatToSlug } from "@/lib/utils/format";
import {
  ArrowLeft,
  CheckCircle,
  Clock,
...
export default function TourDetailsPage() {
  ...
  const destination = mockDestinations.find(
    (dest) => formatToSlug(dest.name) === destinationSlug,
  );
  ...
  const handleBookTour = () => {
    ...
    const tourItem = {
      ...
      guests: guests,
      location: `${tour.location.address}, ${tour.location.city}, ${tour.location.country}`,
      cancellationPolicy:
        ...
        <div className="gap-8 grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4 dark:text-slate-400">{tour.description}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-wrap justify-center gap-4 mb-4">
                  ...
                  <div className="text-center">
                    <p className="font-bold text-3xl text-blue-600">
                      {formatCurrency(tour.pricing.child)}
                    </p>
                    <p className="text-sm">per child</p>
                  </div>
                  <div className="text-center">
                    <p className="font-bold text-3xl text-blue-600">
                      {formatCurrency(tour.pricing.senior)}
                    </p>
                  ...
                  {tour.pricing.student && (
                    <div className="text-center">
                      <p className="font-bold text-3xl text-blue-600">
                        {formatCurrency(tour.pricing.student)}
                      </p>
                  ...
                  {tour.pricing.family && (
                    <div className="text-center">
                      <p className="font-bold text-3xl text-blue-600">
                        {formatCurrency(tour.pricing.family)}
                      </p>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <div className="inline-flex items-center">
                      <span>{formatCurrency(tour.pricing.adult)}</span>
                      <span>/person</span>
                    </div>
                    <div className="inline-flex items-center">
                      <span>× {adults}</span>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="inline-flex items-center">
                      <span>{formatCurrency(tour.pricing.child)}</span>
                      <span>/person</span>
                    </div>
                    <div className="inline-flex items-center">
                      <span>× {children}</span>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="inline-flex items-center">
                      <span>{formatCurrency(tour.pricing.senior)}</span>
                      <span>/person</span>
                    </div>
                    <div className="inline-flex items-center">
                      <span>× {seniors}</span>
                  ...
                  {tour.pricing.student && (
                    <div className="flex justify-between items-center">
                      <div className="inline-flex items-center">
                        <span>{formatCurrency(tour.pricing.student)}</span>
                        <span>/person</span>
                      </div>
                      <div className="inline-flex items-center">
                        <span>× {students}</span>
                  ...
                  {tour.pricing.family && (
                    <div className="flex justify-between items-center">
                      <div className="inline-flex items-center">
                        <span>{formatCurrency(tour.pricing.family)}</span>
                        <span>/family</span>
                      </div>
                      <div className="inline-flex items-center">
                        <span>× {families}</span>
