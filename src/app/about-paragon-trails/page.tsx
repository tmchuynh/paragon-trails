    ...
    <div className="mx-auto pt-8 md:pt-12 lg:pt-24 w-10/12 md:w-11/12">
      ...
      <section className="mb-10">
        ...
        <p className="mb-4">
          ...
          mountaintop with no one else around. It's the intimacy of a candlelit
          dinner where the only noise is the sound of ocean waves. It's the
          warmth of being welcomed like family in a place you've never been
          before.
        </p>
        ...
        <p className="mb-4">
          ...
          inspires you, what restores you. Then, we design a travel experience
          around that. Every route, every accommodation, every experience is
      ...
      <section className="mb-10">
        ...
        <p className="mb-4">
          ...
          that's waiting when you land, to the room where every detail has
          already anticipated your needs, to the local guide who doesn't just
      ...
      <section className="mb-10">
        ...
        <p className="mb-4">
          ...
          hillside in Tuscany, meditating in a silent retreat in Bali, or
          celebrating love on a remote Caribbean island, we ensure the
        ...
        <p className="mb-4">
          ...
          offer rare access, priority service, and the kinds of moments you
        ...
        <div className="gap-6 grid grid-cols-1 md:grid-cols-2">
          ...
          <div>
            ...
            <p>
              ...
              tourism practices that protect what makes each destination
              special.
            </p>
          </div>
        </div>
      ...
      <section className="mb-10">
        ...
        <p className="mb-4">
          ...
          themselves. We serve couples seeking quiet romance, families looking
          for enriching adventures, solo travelers in pursuit of renewal, and
          business leaders in need of serene, high-touch retreats.
        </p>
      </section>
