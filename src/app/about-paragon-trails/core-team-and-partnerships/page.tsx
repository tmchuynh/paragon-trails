		...
		<div className="mx-auto pt-8 md:pt-12 lg:pt-24 w-10/12 md:w-11/12">
			<div className="mx-auto py-8">
				...
				<section>
					...
					<div className="gap-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-4 mb-8">
						{partnerHighlights.map(({ title, description, icon: Icon }) => (
							<div
								key={title}
								className="flex flex-col items-center bg-background p-6 rounded-lg text-center"
							>
