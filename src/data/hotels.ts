...
export const mockHotels: Hotel[] = [
  ...
  // Cape Town Hotels
  {
    ...
    description: "Luxury resort at the foot of Table Mountain with panoramic views, world-class spa, and exclusive amenities.",
    location: {
      address: "1 Table Mountain Road, Camps Bay",
      city: "Cape Town",
      country: "South Africa",
      coordinates: { latitude: -33.9561, longitude: 18.3784 },
      nearbyAttractions: ["Table Mountain", "Camps Bay Beach", "V&A Waterfront", "Kirstenbosch Gardens"],
    },
    amenities: {
      ...
      recreation: ["Spa", "Fitness Center", "Outdoor Pool", "Tennis Court", "Golf Course"],
      dining: ["Fine Dining Restaurant", "Beach Bar", "Room Service", "Wine Cellar"],
  ...
  },
  {
    ...
    description: "Modern hotel in the heart of V&A Waterfront with harbor views and easy access to shopping and dining.",
    location: {
      address: "Dock Road, V&A Waterfront",
      city: "Cape Town",
      country: "South Africa",
      coordinates: { latitude: -33.9022, longitude: 18.4194 },
      nearbyAttractions: ["V&A Waterfront", "Two Oceans Aquarium", "Clock Tower Centre", "Robben Island Ferry"],
    },
    amenities: {
  ...
  },
  {
    ...
    description: "Intimate boutique hotel in a restored Victorian manor with personalized service and unique character.",
    location: {
      address: "15 Kloof Street, Gardens",
      city: "Cape Town",
      country: "South Africa",
      coordinates: { latitude: -33.9304, longitude: 18.4095 },
      nearbyAttractions: ["Company Gardens", "South African Museum", "Table Mountain", "Long Street"],
    },
    amenities: {
  ...
  },
  {
    ...
    description: "Budget-friendly hostel near Sea Point Promenade with ocean views and social atmosphere.",
    location: {
      address: "216 Main Road, Sea Point",
      city: "Cape Town",
      country: "South Africa",
      coordinates: { latitude: -33.9167, longitude: 18.3833 },
      nearbyAttractions: ["Sea Point Promenade", "Clifton Beach", "Lion's Head", "V&A Waterfront"],
    },
    amenities: {
  ...
  },
  {
    ...
    description: "Exclusive luxury villa with private pool, beach access, and stunning mountain and ocean views.",
    location: {
      address: "Victoria Road, Camps Bay",
      city: "Cape Town",
      country: "South Africa",
      coordinates: { latitude: -33.9553, longitude: 18.3763 },
      nearbyAttractions: ["Camps Bay Beach", "Twelve Apostles", "Table Mountain", "Clifton Beach"],
    },
    amenities: {
  ...
  // Cusco Hotels
  {
    ...
    description: "Luxury resort in the Sacred Valley with spa treatments, gourmet dining, and Machu Picchu tour packages.",
    location: {
      address: "Av. Ferrocarril, Sacred Valley",
      city: "Cusco",
      country: "Peru",
      coordinates: { latitude: -13.5170, longitude: -72.0000 },
      nearbyAttractions: ["Sacred Valley", "Ollantaytambo", "Pisaq Market", "Machu Picchu"],
    },
    amenities: {
  ...
  },
  {
    ...
    description: "Colonial-style hotel in the historic center of Cusco, walking distance to major attractions.",
    location: {
      address: "Calle Plateros, San Blas",
      city: "Cusco",
      country: "Peru",
      coordinates: { latitude: -13.5164, longitude: -71.9785 },
      nearbyAttractions: ["Qorikancha", "San Pedro Market", "Plaza de Armas", "Sacsayhuamán"],
    },
    amenities: {
      general: ["Free Wi-Fi", "24/7 Front Desk", "Concierge", "Oxygen Support"],
      business: ["Business Services"],
  ...
  },
  {
    ...
    description: "Charming boutique lodge with traditional Andean decor and personalized Inca Trail experiences.",
    location: {
      address: "Calle Suecia, San Blas",
      city: "Cusco",
      country: "Peru",
      coordinates: { latitude: -13.5120, longitude: -71.9740 },
      nearbyAttractions: ["San Blas Square", "Twelve Angled Stone", "Cathedral", "Inca Museum"],
    },
    amenities: {
      general: ["Free Wi-Fi", "24/7 Front Desk", "Concierge"],
      business: ["Business Services"],
  ...
  },
  {
    ...
    description: "Social hostel for budget travelers with tour booking services and communal areas.",
    location: {
      address: "Calle Procuradores, Centro Histórico",
      city: "Cusco",
      country: "Peru",
      coordinates: { latitude: -13.5184, longitude: -71.9777 },
      nearbyAttractions: ["Plaza de Armas", "San Pedro Market", "Qorikancha", "Pisaq"],
    },
    amenities: {
      general: ["Free Wi-Fi", "24/7 Front Desk", "Luggage Storage"],
      business: [],
  ...
  },
  {
    ...
    description: "Cozy family-run B&B with traditional Peruvian breakfast and mountain views.",
    location: {
      address: "Avenida El Sol, Wanchaq",
      city: "Cusco",
      country: "Peru",
      coordinates: { latitude: -13.5300, longitude: -71.9600 },
      nearbyAttractions: ["Wanchaq Station", "San Pedro Market", "Qorikancha", "University"],
    },
    amenities: {
